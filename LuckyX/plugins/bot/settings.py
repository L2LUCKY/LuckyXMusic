...
from LuckyX.utils.decorators.admins import ActualAdminCB
from LuckyX.utils.decorators.language import language, languageCB
from LuckyX.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from LuckyX.utils.inline.start import private_panel
...
async def gib_repo_callback(_, callback_query):
    await callback_query.edit_message_media(
        media=InputMediaVideo("https://graph.org/file/bde4b31acd61fab0536c6.mp4", has_spoiler=True),
